...
function DisplayComments({ parentID, posts,setPosts}) {
    ...
    // LikeButton post={comment} posts={posts}, the single post need to be post={comment} for each filtered objects but the posts are the array of posts that was passed by the Parent component
    //so posts has to be posts={posts} and not posts={comment} or 
